...
.L3:
  ...
  call printNUM #chama a label para printar os números 
...
.L2:
  ...
  sw a0,0(sp) #carrega de a0 na primeira posição da pilha
  add a0,zero,sp #pega o endereço da primeira posição da pilha e joga em a0
  li a7,4 #imprimi o /n
  ecall
